...
<?php include 'cartIcon.php'; ?>
	...
	<ol id="productList">
		...
		<li id='Jacket<?php echo $jacket['pid']; ?>'>
			...
			<input type='number' class='quantity-input-<?php echo $jacket['pid']; ?>' min='1' value='1' style='width: 60px; margin: 10px;' />
			<button onclick='addProductToCart("jackets-<?php echo $jacket['pid']; ?>", "<?php echo htmlspecialchars($jacket['name']); ?>", <?php echo $jacket['price']; ?>, "jackets", "<?php echo htmlspecialchars($jacket['imagepath']); ?>", <?php echo $jacket['pid']; ?>)'>Add to Cart!</button>
		</li>
